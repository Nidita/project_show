        ...
        <section class="container" id="about">
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-6 about-content">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam repudiandae ab quasi, eius deserunt, ratione voluptates tenetur ullam minima reiciendis, odit ea modi? Illo voluptate magnam voluptatum, ullam iusto excepturi!</p>
                </div>
            </div>
        </section>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide box">
                            ...
                            <div class="content">
                                ...
                                <p>Mother, the most beautiful and compassionate call in the world. And how much every mother has to suffer to hear this small but wonderful call. Today I will discuss some things to do in the...
                                </p>
                                <a href="parenting_blogs/90days_motherhood.html" class="btn">read more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide box">
                            ...
                            <div class="content">
                                ...
                                <p>A good relationship between the child and the parents helps in building a bright future for the child.
                                </p>
                                <a href="parenting_blogs/children_development.html" class="btn">read more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide box">
                            ...
                            <div class="content">
                                <h3>24 hrs Diaper</h3>
                                <p>Diapers are an essential product for babies these days. Parents want to keep babies in diapers for most of the day for their child's and their own convenience..</p>
                                <a href="parenting_blogs/diaper24hrs.html" class="btn">read more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide box">
                            ...
                            <div class="content">
                                ...
                                <p>Mothers wake up every morning and panic about their child's breakfast or food. And if the child's age is between one and five, then there is no word. Because it is at this age that mothers have to suffer the most with baby
                                    food..
                                </p>
                                <a href="parenting_blogs/child_breakfast.html" class="btn">read more</a>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide box">
                            ...
                            <div class="content">
                                ...
                                <p>As a parent, we all have certain moments in our lives that we don't want to remember or can say if we had the power to go back and change the actions of those moments..</p>
                                <a href="parenting_blogs/parenting&guilt.html" class="btn">read more</a>
                            </div>
                        </div>
                        <div class="swiper-slide box">
                            <div class="image">
                                <img src="images/blogs/father-mother.jpg" alt="">
                            </div>
                            <div class="content">
                                <h3>14 Ways Newborn Fathers Can Help Mothers</h3>
                                <p>Breastfeeding the baby in the first few weeks is very difficult for the mother. At this time she may be busy breastfeeding most of the day. As a result...</p>
                                <a href="parenting_blogs/14ways_father.html" class="btn">read more</a>
                            </div>
                        </div>
