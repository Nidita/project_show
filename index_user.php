            ...
            <div class="header-1">
                ...
                <li class="user-drop nav-item dropdown ">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="user-dropdown">
                        ...
                        <hr>
                        <li><a class="dropdown-item" href="user-regi-login/user_edit_profile.php">My Profile</a></li>
                        <hr>
                        <li><a class="dropdown-item" href="booking/bookig_checklist_user.php">My booking</a></li>
                        <hr>
