            ...
            <div class="header-1">
                ...
                <li class="user-drop nav-item dropdown ">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="user-dropdown">
                        <li><a class="dropdown-item" href="daycare-edit.php">Edit Profile</a></li>
                        <hr>
                        <li><a class="dropdown-item" href="../booking/booking_checklist_daycare_pending.php">Pending Bookings</a></li>
                        <hr>
                        <li><a class="dropdown-item" href="../booking/confirm.php">Confirmed Bookings</a></li>
                        <hr>
